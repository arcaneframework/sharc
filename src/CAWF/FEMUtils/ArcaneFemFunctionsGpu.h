                   ...
                   const Accelerator::VariableNodeReal3InView& in_node_coord)
{
  ...
  Real3 n2 = in_node_coord[cn_cv.nodeId(cell_lid, 2)];
  Real3 n3 = in_node_coord[cn_cv.nodeId(cell_lid, 3)];
  Real3 n4 = in_node_coord[cn_cv.nodeId(cell_lid, 4)];
  Real3 n5 = in_node_coord[cn_cv.nodeId(cell_lid, 5)];
  Real3 n6 = in_node_coord[cn_cv.nodeId(cell_lid, 6)];
  Real3 n7 = in_node_coord[cn_cv.nodeId(cell_lid, 7)];
