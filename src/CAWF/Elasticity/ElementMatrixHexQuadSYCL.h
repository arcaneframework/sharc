...
computeElementMatrixQuad4Base(const RealVector<4>& dxu,
                              const RealVector<4>& dyu,
...
computeElementMatrixHexa8Base(const RealVector<8>& dxu,
                              const RealVector<8>& dyu,
                              const RealVector<8>& dzu,
                              Real integration_weight,
                              Real lambda,
                              Real mu)
{
