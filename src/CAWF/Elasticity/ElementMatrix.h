                             ...
                             const Accelerator::VariableCellRealInView& mu)
{
  ...
  return computeElementMatrixTria3Base(dxu, dyu, area, lambda[cell_lid], mu[cell_lid]);
}
...
RealMatrix<6, 6> FemModuleElasticity::_computeElementMatrixTria3(Cell cell)
{
  ...
  return computeElementMatrixTria3Base(dxu, dyu, area, m_cell_lambda[cell], m_cell_mu[cell]);
}
...
RealMatrix<12, 12> FemModuleElasticity::_computeElementMatrixTetra4(Cell cell)
{
  ...
  return computeElementMatrixTetra4Base(dxu, dyu, dzu, volume, m_cell_lambda[cell], m_cell_mu[cell]);
}
                              ...
                              const Accelerator::VariableCellRealInView& mu)
{
  ...
  return computeElementMatrixTetra4Base(dxu, dyu, dzu, volume, lambda[cell_lid], mu[cell_lid]);
}
