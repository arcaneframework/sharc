...
public:
    ...
    : VariableImpl(Arcane::VariableBuildInfo(vbi.mesh(),
                                             ...
                                             vbi.property())){}
#if (ARCANE_VERSION >= 31609)
  ConstReturnType operator[] (const ItemConnection& item_connection) const
  {return VariableImpl::operator [](Arcane::ItemLocalIdT<ItemConnectionImpl::type>(item_connection.internal()));}
  ConstReturnType operator[] (const ItemConnectionEnumerator& item_connection_enumerator) const
  {return VariableImpl::operator [](Arcane::ItemLocalIdT<ItemConnectionImpl::type>(item_connection_enumerator->internal()));}
  ReturnType operator[] (const ItemConnection& item_connection)
  {return VariableImpl::operator [](Arcane::ItemLocalIdT<ItemConnectionImpl::type>(item_connection.internal()));}
  ReturnType operator[] (const ItemConnectionEnumerator& item_connection_enumerator)
  {return VariableImpl::operator [](Arcane::ItemLocalIdT<ItemConnectionImpl::type>(item_connection_enumerator->internal()));}
#else
  ConstReturnType operator[] (const ItemConnection& item_connection) const
  {return VariableImpl::operator [](item_connection.internal());}
  ConstReturnType operator[] (const ItemConnectionEnumerator& item_connection_enumerator) const
  {return VariableImpl::operator [](item_connection_enumerator->internal());}
  ReturnType operator[] (const ItemConnection& item_connection)
  {return VariableImpl::operator [](item_connection.internal());}
...
public:
  ...
  ConstReturnType operator[] (const ItemConnectionEnumerator& item_connection_enumerator) const
  {return VariableImpl::operator [](item_connection_enumerator);}
#if (ARCANE_VERSION >= 31609)
  ConstReturnType operator[] (const ItemConnection& item_connection) const
    {return VariableImpl::operator [](Arcane::ItemLocalIdT<ItemConnectionImpl::type>(item_connection.internal()));}
  ReturnType operator[] (const ItemConnectionEnumerator& item_connection_enumerator)
