...
//-----------------------------------------------------------------------------
#ifndef PFUUNITSSYSTEM_H
#define PFUUNITSSYSTEM_H

#include "IUnitsSystem.h"
#include "PFUUnitsSystem_axl.h"
...
class PFUUnitsSystemService :
    public ArcanePFUUnitsSystemObject
{
public:
  /** Constructeur de la classe */
  PFUUnitsSystemService(const ServiceBuildInfo & sbi) 
  : ArcanePFUUnitsSystemObject(sbi) 
  {
