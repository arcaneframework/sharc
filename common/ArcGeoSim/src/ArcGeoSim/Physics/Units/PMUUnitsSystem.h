...
class PMUUnitsSystemService :
    public ArcanePMUUnitsSystemObject
{
public:
  /** Constructeur de la classe */
  PMUUnitsSystemService(const ServiceBuildInfo & sbi)
  : ArcanePMUUnitsSystemObject(sbi)
  {
