#ifndef __audi_sparse_operators_unary_add_h__
#define __audi_sparse_operators_unary_add_h__
...
inline audi::sparse_expression<T> operator+(R u, const audi::sparse_expression<T>& v) {
  return audi::sparse_expression<T>(u + v.first, audi::make_node(T(1), v));
}

template<class T, class R>
inline audi::sparse_expression<T> operator+(const audi::sparse_expression<T>& u, R v) {
  return audi::sparse_expression<T>(u.first + v, audi::make_node(T(1), u));
}

#endif /* __audi_sparse_operators_unary_add_h__ */
