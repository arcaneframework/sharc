...
//-----------------------------------------------------------------------------
#ifndef __audi_dense_node_add_h__
#define __audi_dense_node_add_h__

namespace audi {

  template<typename L, typename R>
  struct add
    : public expression<add<L,R>>
    , private node
  {
    ...
    add(const expression<L>& l, const expression<R>& r)
      : m_l(l.staticCast())
      , m_r(r.staticCast())
      , m_lv(m_l.value())
      , m_rv(m_r.value())
...
#endif /* __audi_dense_node_add_h__ */
