#ifndef __audi_dense_node_div_h__
#define __audi_dense_node_div_h__

namespace audi {

  template<typename L, typename R>
  struct div
    : public expression<div<L,R>>
    , private node
  {
    ...
    div(const expression<L>& l, const expression<R>& r)
      : m_l(l.staticCast())
      , m_r(r.staticCast())
      , m_lv(m_l.value())
      , m_rv(m_r.value())
    ...
    {
      return (m_l.gradient(i) * m_rv - m_lv * m_r.gradient(i)) / (m_rv*m_rv);
    }
...
#endif /* __audi_dense_node_div_h__ */
