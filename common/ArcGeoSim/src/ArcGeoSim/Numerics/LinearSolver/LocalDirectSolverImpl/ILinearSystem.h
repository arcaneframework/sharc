 ...
 * ThreeStep (definition + localisation + remplissage), OneStep (remplissage avec définition implicite), 
...
public:
  ...
  virtual Arcane::IParallelMng* getParallelMng() {
    return NULL ;
  }

  virtual Arcane::ITraceMng* getTraceMng() {
    return NULL ;
  }
};
