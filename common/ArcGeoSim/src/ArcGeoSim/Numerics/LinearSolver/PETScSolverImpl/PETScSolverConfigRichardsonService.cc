...
#include "PETScSolverConfigRichardson_axl.h"
...
class PETScSolverConfigRichardsonService :
...
configure(KSP & ksp, const Alien::IIndexManager * indexManager)
{
  ...
  if (options()->scale() != 0.0)
    checkError("Set Richardson Scale",KSPRichardsonSetScale(ksp,options()->scale()));
  else
