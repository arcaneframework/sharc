...
#include "StandardDivKGradTwoPointsActive_axl.h"
...
/*!
  ...
  \date 2020-12-23
*/
class StandardDivKGradTwoPointsActiveService :
  public IDivKGradDiscreteOperator,
  public ArcaneStandardDivKGradTwoPointsActiveObject {
public:
  //! Constructor
  StandardDivKGradTwoPointsActiveService(const ServiceBuildInfo& sbi) :
    ArcaneStandardDivKGradTwoPointsActiveObject(sbi),
  ...
  //! Destructor
  virtual ~StandardDivKGradTwoPointsActiveService()
  {
    // Delete m_face group
  }
...
template<typename VariableTypeT>
void StandardDivKGradTwoPointsActiveService::_form_discrete_operator(const VariableTypeT & k)
{
  ARCANE_ASSERT( (m_status & DiscreteOperatorProperty::S_PREPARED),
