...
#include "StandardDivKGradTwoPointsService.h"
...
void StandardDivKGradTwoPointsService::init() 
{
...
void StandardDivKGradTwoPointsService::prepare(IMesh * mesh,
...
void StandardDivKGradTwoPointsService::prepare(const FaceGroup & internal_faces,
...
void StandardDivKGradTwoPointsService::finalize() 
{
...
void StandardDivKGradTwoPointsService::formDiscreteOperator(const VariableCellReal& k) 
{
...
void StandardDivKGradTwoPointsService::formDiscreteOperator(const VariableCellReal3& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsService::formDiscreteOperator(const VariableCellReal3x3& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsService::formDiscreteOperator(const SharedVariableCellReal& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsService::formDiscreteOperator(const SharedVariableCellReal3& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsService::formDiscreteOperator(const SharedVariableCellReal3x3& k) 
{
  _form_discrete_operator(k);
}

ARCANE_REGISTER_SERVICE_STANDARDDIVKGRADTWOPOINTS(StandardDivKGradTwoPoints,
                                                  StandardDivKGradTwoPointsService);
