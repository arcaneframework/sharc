...
#include "StandardDivKGradTwoPointsActiveService.h"
...
void StandardDivKGradTwoPointsActiveService::init() 
{
...
void StandardDivKGradTwoPointsActiveService::prepare(IMesh * mesh,
                                               ...
                                               CoefficientArrayT<Face> * face_coefficients) 
{
  ...
  m_cells          = mesh->allActiveCells();
  m_faces          = mesh->allActiveFaces();
  m_internal_faces = mesh->allActiveCells().innerActiveFaceGroup();
  m_boundary_faces = mesh->allActiveCells().outerActiveFaceGroup();
...
void StandardDivKGradTwoPointsActiveService::prepare(const FaceGroup & internal_faces,
...
void StandardDivKGradTwoPointsActiveService::finalize() 
{
...
void StandardDivKGradTwoPointsActiveService::formDiscreteOperator(const VariableCellReal& k) 
{
...
void StandardDivKGradTwoPointsActiveService::formDiscreteOperator(const VariableCellReal3& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsActiveService::formDiscreteOperator(const VariableCellReal3x3& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsActiveService::formDiscreteOperator(const SharedVariableCellReal& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsActiveService::formDiscreteOperator(const SharedVariableCellReal3& k) 
{
  _form_discrete_operator(k);
}
...
void StandardDivKGradTwoPointsActiveService::formDiscreteOperator(const SharedVariableCellReal3x3& k) 
{
  _form_discrete_operator(k);
}

ARCANE_REGISTER_SERVICE_STANDARDDIVKGRADTWOPOINTSACTIVE(StandardDivKGradTwoPointsActive,
                                                  StandardDivKGradTwoPointsActiveService);
