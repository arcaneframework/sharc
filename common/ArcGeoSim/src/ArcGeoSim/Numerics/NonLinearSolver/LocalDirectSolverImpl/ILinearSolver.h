...
/**
 * Interface du service du module de resolution lin�aire.
 * Voir \ref secLinearSolver "Description des services de solveurs lin�aires" pour plus de d�tails
 */
...
#include "ArcGeoSim/Numerics/NonLinearSolver/LocalDirectSolverImpl/IBaseLinearSolver.h"
