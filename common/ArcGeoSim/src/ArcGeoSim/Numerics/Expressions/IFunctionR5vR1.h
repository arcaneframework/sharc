...
//-----------------------------------------------------------------------------
// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_IFUNCTIONR5VR1_H
#define ARCGEOSIM_EXPRESSIONS_IFUNCTIONR5VR1_H
...
class IFunctionR5vR1 : public IIFunction
{
public:
  
  IFunctionR5vR1() {}
  
  virtual ~IFunctionR5vR1() {}
  
public:

  //! Getting dimension of in-space
  Integer getInDimension() const { return 5; }
...
#endif /* ARCGEOSIM_EXPRESSIONS_IFUNCTIONR5VR1_H */
