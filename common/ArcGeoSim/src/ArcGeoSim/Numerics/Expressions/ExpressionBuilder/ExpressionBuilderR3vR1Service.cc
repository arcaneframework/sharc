...
#include "ExpressionBuilderR3vR1_axl.h"
...
class ExpressionBuilderR3vR1Service
  : public ArcaneExpressionBuilderR3vR1Object
  , public ExpressionBuilderR3vR1Core
{
public:
  
  ExpressionBuilderR3vR1Service(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneExpressionBuilderR3vR1Object(sbi)
  , ExpressionBuilderR3vR1Core(new FunctionParser,true)
  , m_initialized(false) {}
  
  ~ExpressionBuilderR3vR1Service() {}
...
{
  if (!m_initialized) {
    fatal() << "ExpressionBuilderR3vR1Service not initialized";
  }
  
  ExpressionBuilderR3vR1Core::eval(var0,
                                   var1,
                                   var2,
                                   res0);
}
     ...
     const Arcane::Real& var2)
{
  ...
  return ExpressionBuilderR3vR1Core::eval(var0,
                                          var1,
                                          var2);
}
...
ARCANE_REGISTER_SERVICE_EXPRESSIONBUILDERR3VR1(ExpressionBuilderR3vR1,ExpressionBuilderR3vR1Service);
