...
#include "ExpressionBuilderR7vR1_axl.h"
...
class ExpressionBuilderR7vR1Service
  : public ArcaneExpressionBuilderR7vR1Object
  , public ExpressionBuilderR7vR1Core
{
public:
  
  ExpressionBuilderR7vR1Service(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneExpressionBuilderR7vR1Object(sbi)
  , ExpressionBuilderR7vR1Core(new FunctionParser,true)
  , m_initialized(false) {}
  
  ~ExpressionBuilderR7vR1Service() {}
...
{
  if (!m_initialized) {
    fatal() << "ExpressionBuilderR7vR1Service not initialized";
  }
  
  ExpressionBuilderR7vR1Core::eval(var0,
                                   var1,
                                   var2,
                                   var3,
                                   var4,
     ...
     const Arcane::Real& var6)
{
  ...
  return ExpressionBuilderR7vR1Core::eval(var0,
                                          var1,
                                          var2,
                                          var3,
                                          var4,
...
ARCANE_REGISTER_SERVICE_EXPRESSIONBUILDERR7VR1(ExpressionBuilderR7vR1,ExpressionBuilderR7vR1Service);
