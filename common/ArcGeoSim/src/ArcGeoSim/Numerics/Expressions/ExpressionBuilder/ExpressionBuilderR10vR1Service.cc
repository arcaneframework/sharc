...
#include "ExpressionBuilderR10vR1_axl.h"
...
class ExpressionBuilderR10vR1Service
  : public ArcaneExpressionBuilderR10vR1Object
  , public ExpressionBuilderR10vR1Core
{
public:
  
  ExpressionBuilderR10vR1Service(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneExpressionBuilderR10vR1Object(sbi)
  , ExpressionBuilderR10vR1Core(new FunctionParser,true)
  , m_initialized(false) {}
  
  ~ExpressionBuilderR10vR1Service() {}
...
{
  if (!m_initialized) {
    fatal() << "ExpressionBuilderR10vR1Service not initialized";
  }
  
  ExpressionBuilderR10vR1Core::eval(var0,
                                   var1,
                                   var2,
                                   var3,
                                   var4,
     ...
     const Arcane::Real& var9)
{
  ...
  return ExpressionBuilderR10vR1Core::eval(var0,
                                          var1,
                                          var2,
                                          var3,
                                          var4,
...
ARCANE_REGISTER_SERVICE_EXPRESSIONBUILDERR10VR1(ExpressionBuilderR10vR1,ExpressionBuilderR10vR1Service);
