// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER7VR1CORE_H
#define ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER7VR1CORE_H
...
#include "ArcGeoSim/Numerics/Expressions/IFunctionR7vR1.h"
...
class ExpressionBuilderR7vR1Core
  : public IFunctionR7vR1
{
public:
  ExpressionBuilderR7vR1Core(FunctionParser * function_parser,
                             bool delegate_destroy = false);

  virtual ~ExpressionBuilderR7vR1Core();
...
#endif /*  ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER7VR1CORE_H */
