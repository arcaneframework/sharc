// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER5VR1CORE_H
#define ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER5VR1CORE_H
...
#include "ArcGeoSim/Numerics/Expressions/IFunctionR5vR1.h"
...
class ExpressionBuilderR5vR1Core
  : public IFunctionR5vR1
{
public:
  ExpressionBuilderR5vR1Core(FunctionParser * function_parser,
                             bool delegate_destroy = false);

  virtual ~ExpressionBuilderR5vR1Core();
...
#endif /*  ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER5VR1CORE_H */
