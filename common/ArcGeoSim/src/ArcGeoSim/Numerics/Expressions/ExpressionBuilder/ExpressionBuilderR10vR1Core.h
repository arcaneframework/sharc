// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER10VR1CORE_H
#define ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER10VR1CORE_H
...
#include "ArcGeoSim/Numerics/Expressions/IFunctionR10vR1.h"
...
class ExpressionBuilderR10vR1Core
  : public IFunctionR10vR1
{
public:
  ExpressionBuilderR10vR1Core(FunctionParser * function_parser,
                             bool delegate_destroy = false);

  virtual ~ExpressionBuilderR10vR1Core();
...
#endif /*  ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER10VR1CORE_H */
