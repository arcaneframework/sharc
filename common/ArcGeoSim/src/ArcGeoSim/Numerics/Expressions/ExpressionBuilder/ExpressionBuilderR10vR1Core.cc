...
#include "ExpressionBuilderR10vR1Core.h"
...
ExpressionBuilderR10vR1Core::
ExpressionBuilderR10vR1Core(FunctionParser * function_parser,
...

{
  ...
  const std::string var7_name = m_function_parser->getVariable(7);
  m_function_parser->setVariable(var7_name, & var7, 1);
  const std::string var8_name = m_function_parser->getVariable(8);
  m_function_parser->setVariable(var8_name, & var8, 1);
  const std::string var9_name = m_function_parser->getVariable(9);
  m_function_parser->setVariable(var9_name, & var9, 1);
...
eval(const Arcane::Array<Arcane::Real>& var0,
     ...
     const Arcane::Array<Arcane::Real>& var9,
           Arcane::Array<Arcane::Real>& res0)
{
  ...
  const std::string var7_name = m_function_parser->getVariable(7);
  m_function_parser->setVariable(var7_name, var7.unguardedBasePointer(), var7.size());  
  const std::string var8_name = m_function_parser->getVariable(8);
  m_function_parser->setVariable(var8_name, var8.unguardedBasePointer(), var8.size());  
  const std::string var9_name = m_function_parser->getVariable(9);
  m_function_parser->setVariable(var9_name, var9.unguardedBasePointer(), var9.size());  
...
eval(Arcane::RealConstArrayView var0,
     ...
     Arcane::RealConstArrayView var9,
