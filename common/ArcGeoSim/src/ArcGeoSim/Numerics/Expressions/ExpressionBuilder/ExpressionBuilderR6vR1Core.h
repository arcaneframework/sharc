// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER6VR1CORE_H
#define ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER6VR1CORE_H
...
#include "ArcGeoSim/Numerics/Expressions/IFunctionR6vR1.h"
...
class ExpressionBuilderR6vR1Core
  : public IFunctionR6vR1
{
public:
  ExpressionBuilderR6vR1Core(FunctionParser * function_parser,
                             bool delegate_destroy = false);

  virtual ~ExpressionBuilderR6vR1Core();
...
#endif /*  ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER6VR1CORE_H */
