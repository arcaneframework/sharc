// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER1VR1CORE_H
#define ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER1VR1CORE_H
...
class ExpressionBuilderR1vR1Core
  : public IFunctionR1vR1
{
public:
  ExpressionBuilderR1vR1Core(FunctionParser * function_parser,
                             bool delegate_destroy = false);

  virtual ~ExpressionBuilderR1vR1Core();
...
#endif /*  ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER1VR1CORE_H */
