...
#include "ExpressionBuilderR6vR1Core.h"

#include "ExpressionBuilderR6vR1_axl.h"
...
class ExpressionBuilderR6vR1Service
  : public ArcaneExpressionBuilderR6vR1Object
  , public ExpressionBuilderR6vR1Core
{
public:
  
  ExpressionBuilderR6vR1Service(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneExpressionBuilderR6vR1Object(sbi)
  , ExpressionBuilderR6vR1Core(new FunctionParser,true)
  , m_initialized(false) {}
  
  ~ExpressionBuilderR6vR1Service() {}
...
{
  if (!m_initialized) {
    fatal() << "ExpressionBuilderR6vR1Service not initialized";
  }
  
  ExpressionBuilderR6vR1Core::eval(var0,
                                   var1,
                                   var2,
                                   var3,
                                   var4,
     ...
     const Arcane::Real& var5)
{
  ...
  return ExpressionBuilderR6vR1Core::eval(var0,
                                          var1,
                                          var2,
                                          var3,
                                          var4,
...
ARCANE_REGISTER_SERVICE_EXPRESSIONBUILDERR6VR1(ExpressionBuilderR6vR1,ExpressionBuilderR6vR1Service);
