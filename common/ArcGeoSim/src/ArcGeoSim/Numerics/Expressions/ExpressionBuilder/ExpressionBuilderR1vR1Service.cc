...
#include "ExpressionBuilderR1vR1_axl.h"
...
class ExpressionBuilderR1vR1Service
  : public ArcaneExpressionBuilderR1vR1Object
  , public ExpressionBuilderR1vR1Core
{
public:
  
  ExpressionBuilderR1vR1Service(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneExpressionBuilderR1vR1Object(sbi)
  , ExpressionBuilderR1vR1Core(new FunctionParser,true)
  , m_initialized(false) {}
  
  ~ExpressionBuilderR1vR1Service() {}
...
{
  if (!m_initialized) {
    fatal() << "ExpressionBuilderR1vR1Service not initialized";
  }
  
  ExpressionBuilderR1vR1Core::eval(var0,
                                   res0);
}
...
eval(const Arcane::Real& var0)
{
  ...
  return ExpressionBuilderR1vR1Core::eval(var0);
}
...
ARCANE_REGISTER_SERVICE_EXPRESSIONBUILDERR1VR1(ExpressionBuilderR1vR1,ExpressionBuilderR1vR1Service);
