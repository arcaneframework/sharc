...
#include "ExpressionBuilderR9vR1_axl.h"
...
class ExpressionBuilderR9vR1Service
  : public ArcaneExpressionBuilderR9vR1Object
  , public ExpressionBuilderR9vR1Core
{
public:
  
  ExpressionBuilderR9vR1Service(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneExpressionBuilderR9vR1Object(sbi)
  , ExpressionBuilderR9vR1Core(new FunctionParser,true)
  , m_initialized(false) {}
  
  ~ExpressionBuilderR9vR1Service() {}
...
{
  if (!m_initialized) {
    fatal() << "ExpressionBuilderR9vR1Service not initialized";
  }
  
  ExpressionBuilderR9vR1Core::eval(var0,
                                   var1,
                                   var2,
                                   var3,
                                   var4,
     ...
     const Arcane::Real& var8)
{
  ...
  return ExpressionBuilderR9vR1Core::eval(var0,
                                          var1,
                                          var2,
                                          var3,
                                          var4,
...
ARCANE_REGISTER_SERVICE_EXPRESSIONBUILDERR9VR1(ExpressionBuilderR9vR1,ExpressionBuilderR9vR1Service);
