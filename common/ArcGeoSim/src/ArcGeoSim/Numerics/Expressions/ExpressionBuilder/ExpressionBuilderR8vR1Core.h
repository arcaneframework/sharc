// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER8VR1CORE_H
#define ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER8VR1CORE_H
...
#include "ArcGeoSim/Numerics/Expressions/IFunctionR8vR1.h"
...
class ExpressionBuilderR8vR1Core
  : public IFunctionR8vR1
{
public:
  ExpressionBuilderR8vR1Core(FunctionParser * function_parser,
                             bool delegate_destroy = false);

  virtual ~ExpressionBuilderR8vR1Core();
...
#endif /*  ARCGEOSIM_EXPRESSIONS_EXPRESSIONBUILDER_EXPRESSIONBUILDER8VR1CORE_H */
