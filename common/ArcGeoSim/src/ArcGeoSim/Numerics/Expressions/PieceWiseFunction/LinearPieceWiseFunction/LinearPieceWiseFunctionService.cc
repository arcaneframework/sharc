#include "LinearPieceWiseFunctionService.h"
...
void
LinearPieceWiseFunctionService::init()
  {
    if (m_initialized)
      return;
    ...
    PieceWiseFunctionR1vR1T<LinearInterpolator>::init();
...
ARCANE_REGISTER_SERVICE_LINEARPIECEWISEFUNCTION(LinearPieceWiseFunction,LinearPieceWiseFunctionService);
