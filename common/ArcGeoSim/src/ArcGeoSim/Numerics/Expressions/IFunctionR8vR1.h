...
//-----------------------------------------------------------------------------
// -*- C++ -*-
#ifndef ARCGEOSIM_EXPRESSIONS_IFUNCTIONR8VR1_H
#define ARCGEOSIM_EXPRESSIONS_IFUNCTIONR8VR1_H
...
class IFunctionR8vR1 : public IIFunction
{
public:
  
  IFunctionR8vR1() {}
  
  virtual ~IFunctionR8vR1() {}
  
public:

  //! Getting dimension of in-space
  Integer getInDimension() const { return 8; }
...
#endif /* ARCGEOSIM_EXPRESSIONS_IFUNCTIONR8VR1_H */
