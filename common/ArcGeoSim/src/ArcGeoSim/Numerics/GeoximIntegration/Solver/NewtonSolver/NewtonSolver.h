...
#include "ArcGeoSim/Numerics/GeoximIntegration/Solver/INewtonSolver.h"
// instead ProfilingNewton
#include "ArcGeoSim/Numerics/GeoximIntegration/Solver/Newton.h"
#include "ArcGeoSim/Numerics/GeoximIntegration/LinearAlgebra/LinearSystem/LinearSystem.h"
#include "ArcGeoSim/Numerics/GeoximIntegration/LinearAlgebra/Vector.h"
#include "ArcGeoSim/Numerics/GeoximIntegration/LinearAlgebra/Matrix.h"
...
public:
  ...
  void init(std::shared_ptr<ArcNum::INonLinearSystem> non_linear_system,
            std::shared_ptr<ArcNum::MultiPointsStencil> multiStencil = nullptr);
...
private:
  ...
  // TODO : To split (XT)
  void _multiPointsProfiler(Arcane::IMesh* mesh,
                          Arcane::CellGroup cells,
			  Alien::MatrixProfiler& blockProfiler,
			    Arcane::ConstArray2View<Arcane::Integer> indexes) const;
...
private:
  ...
  // TODO : To split (XT)
  std::shared_ptr<ArcNum::MultiPointsStencil> m_multiStencil ;
