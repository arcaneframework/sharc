 ...
 * \param own Si la classe own le tableau de derivee
 */
...
/*! \brief Operateur d'affectation pour le tableau de derivees
 * 
 * Permet a la classe Fad de pointer sur un tableau de derivees externe
 * 
 * \param value Tableau de derivees de dimension 2
 */
