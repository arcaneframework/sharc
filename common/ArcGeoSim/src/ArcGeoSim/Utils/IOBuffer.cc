...
split(const String& strbuffer,Array<String>& buffer,const String& sep,Integer size)
{
  ...
  ARCANE_ASSERT((i==size),("Inconsistent String buffer length"));
}
...
getReal()
{
  ...
  if (m_stream->good())
    return v;
  throw Arcane::IOException("IOFile::getReal()","Bad Real");
}
...
getInteger()
{
  ...
  if (m_stream->good())
    return v;
  throw Arcane::IOException("IOFile::getInteger()","Bad Integer");
}
const char* IOFile::
getNextLine()
{
  ...
  throw Arcane::IOException("IfpVtkFile::getNexLine()","Unexpected EndOfFile");
}
...
void IOFile::getValue(String& str)
{
  ...
  if (m_stream->good())
    return ;
  throw Arcane::IOException("IOFile::getValue()","Bad Type");
}
