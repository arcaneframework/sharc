...
int AlienTesterService::test() {
  Timer timer(subDomain(),"AlienTesterService",Timer::TimerVirtual);
  m_w.resize(2);
...
//                  }
      ...
      if (subDomain()->parallelMng()->commRank() == 0)
        {
          info() << "========= Alien Statistics Summary with " << builderNodeList[ibuilder].value() << " =============";
...
void
AlienTesterService::buildAndFillInVector(Alien::Vector& vectorB, const double& value)
{
#if defined(USE_ALIEN_V1) || defined(USE_ALIEN_V2)
  {
...
AlienTesterService::solve(Alien::ILinearSolver * solver,
...
#endif
#if (defined(USE_ALIEN_V1) || defined(USE_ALIEN_V2) ) && defined(ALIEN_USE_MTL4)
  /*
...
ARCANE_REGISTER_SERVICE_ALIENTESTER(AlienTester,AlienTesterService);
