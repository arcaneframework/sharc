...
#include "AlienStrongOptionsTester_axl.h"
...
class AlienStrongOptionsTesterService :
  public ArcaneAlienStrongOptionsTesterObject
{
public:
  typedef Alien::BlockMatrix MatrixType;
  typedef Alien::BlockVector VectorType;

  AlienStrongOptionsTesterService(const Arcane::ServiceBuildInfo & sbi)
    : ArcaneAlienStrongOptionsTesterObject(sbi)
    , m_diag_coeff(0.) {}

  ~AlienStrongOptionsTesterService() {
  }
...
void AlienStrongOptionsTesterService::init()
{
...
void AlienStrongOptionsTesterService::
_createStrongSolverPETScBiCGStabJacobi()
{
  //
...
ARCANE_REGISTER_SERVICE_LINEARALGEBRA2STRONGOPTIONSTESTER(AlienStrongOptionsTester,AlienStrongOptionsTesterService);
