...
#include "AlienBlockTester_axl.h"
...
class AlienBlockTesterService :
  public ArcaneAlienBlockTesterObject
{
public:
  ...
  AlienBlockTesterService(const Arcane::ServiceBuildInfo & sbi)
    : ArcaneAlienBlockTesterObject(sbi)
    , m_stencil_kind(Arcane::IK_Unknown)
    , m_diag_coeff(0.) {}

  ~AlienBlockTesterService() {}
...
void AlienBlockTesterService::init()
{
...
ARCANE_REGISTER_SERVICE_ALIENBLOCKTESTER(AlienBlockTester,AlienBlockTesterService);
