#ifndef ARCGEOSIM_TESTS_SERVICETESTERS_ALIENTESTERSERVICE_H
#define ARCGEOSIM_TESTS_SERVICETESTERS_ALIENTESTERSERVICE_H
/* Author :
 *
 */

#include "Main/Tests/ServiceTesters/IServiceTester.h"
#ifdef USE_ALIEN_V1
...
#include "Main/Tests/ServiceTesters/AlienTester/AlienTestOptionTypes.h"

#include "AlienTester_axl.h"

class MemoryAllocationTracker;

class AlienTesterService :
  public ArcaneAlienTesterObject
{
public:

  //! Constructor
  AlienTesterService(const Arcane::ServiceBuildInfo & sbi) :
    ArcaneAlienTesterObject(sbi)
  {}
  
  //! Destructor
  virtual ~AlienTesterService() {};
...
private:
  ...
  class BuildingStat {
  public:
    BuildingStat(AlienTesterService * owner, Arcane::Timer & timer) 
  ...
  private:
    AlienTesterService * m_owner = nullptr;
