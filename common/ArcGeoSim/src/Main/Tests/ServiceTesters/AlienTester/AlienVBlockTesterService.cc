...
#include "AlienVBlockTester_axl.h"
...
class AlienVBlockTesterService 
    : public ArcaneAlienVBlockTesterObject
{
public:
  ...
  AlienVBlockTesterService(const Arcane::ServiceBuildInfo & sbi) 
  : ArcaneAlienVBlockTesterObject(sbi)
  , m_uniform(m_generator) {}

  ~AlienVBlockTesterService() {}
...
ARCANE_REGISTER_SERVICE_ALIENVBLOCKTESTER(AlienVBlockTester,AlienVBlockTesterService);
