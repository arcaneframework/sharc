...
#include "AnyItemAlienTester_axl.h"
...
class AnyItemAlienTesterService
  : public ArcaneAnyItemAlienTesterObject
{
public:
  
  /** Constructeur de la classe */
  AnyItemAlienTesterService(const Arcane::ServiceBuildInfo & sbi);
 
  /** Destructeur de la classe */
  ~AnyItemAlienTesterService() {}
...
AnyItemAlienTesterService::
AnyItemAlienTesterService(const Arcane::ServiceBuildInfo & sbi)
  : ArcaneAnyItemAlienTesterObject(sbi)
...
ARCANE_REGISTER_SERVICE_ANYITEMALIENTESTER(AnyItemAlienTester,AnyItemAlienTesterService);
