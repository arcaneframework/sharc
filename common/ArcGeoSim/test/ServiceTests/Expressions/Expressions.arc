...
<!--      <grid-type>uniform</grid-type>-->
    ...
    <regular-grid-data-function name="OnePointInterpGridDataFunction">
      <filename>grid_xy.xml.xml</filename>
      <grid-type>non-uniform</grid-type>
<!--      <filename>grid_xy.xml</filename>-->
<!--      <grid-type>uniform</grid-type>-->
