...
namespace CMakeListGenerator
{
  public partial class CMakeList
  {
	...
	public IEnumerable<String> GumpFiles {
		get {
			return Makefile.files.Files (default(Language).Gump ());
		}
		set {
			extendFiles(value, default(Language).Gump ());
		}
	}
	
	public IEnumerable<String> LawDebugFiles {
      get {
        return Makefile.files.Files (default(Language).LawDebug ());
      }
      set {
        extendFiles(value, default(Language).LawDebug ());
      }
    }
    ...
    public IEnumerable<String> LawSequentialFiles {
      ...
      set {
        extendFiles(value, default(Language).LawSequential ());
      }
    }

    public IEnumerable<String> LawFiles {
      get {
        return Makefile.files.Files (default(Language).Law ());
      }
      set {
        extendFiles(value, default(Language).Law ());
      }
    }
   
    public IEnumerable<String> LawHeaders {
      get {
        return Makefile.files.Headers (default(Language).Law ());
      }
    }
    ...
    public IEnumerable<String> StrongServiceFiles {
	  get {
	    return Makefile.files.Files (default(Language).ServiceStrong ());
	  }
	  set {
        extendFiles(value, default(Language).ServiceStrong ());
	  }
	}

    public IEnumerable<String> CaseAndStrongServiceFiles {
      get {
        return Makefile.files.Files (default(Language).ServiceCaseAndStrong ());
      }
      set {
        extendFiles(value, default(Language).ServiceCaseAndStrong ());
      }
    }
	...
	public IEnumerable<String> CaseAndStrongAxlFiles {
	  get {
		var axls = new List<string> ();
		axls.AddRange (Makefile.files.Files (default(Language).AxlCaseAndStrong ()));
		axls.AddRange (CaseAndStrongServiceFiles);
		return axls;
	  }
	  set {
		extendFiles(value, default(Language).AxlCaseAndStrong ());
	  }
	}

	public IEnumerable<String> StrongAxlFiles {
	  get {
		var axls = new List<string> ();
		axls.AddRange (Makefile.files.Files (default(Language).AxlStrong ()));
		axls.AddRange (StrongServiceFiles);
		return axls;
	  }
	  set {
		extendFiles(value, default(Language).AxlStrong ());
	  }
	}

    public IEnumerable<String> AllServiceFiles {
      get {
        var axls = new List<string> ();
        axls.AddRange (Makefile.files.Files (default(Language).Service ()));
        axls.AddRange (CaseAndStrongServiceFiles);
        axls.AddRange (StrongServiceFiles);
        return axls;
      }
