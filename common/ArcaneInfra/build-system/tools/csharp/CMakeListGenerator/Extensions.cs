...
static class LanguageExtensions {
  ...
  public static CMakeListGenerator.Language Gump(this CMakeListGenerator.Language l) {
	return CMakeListGenerator.Language.gump;
  }
  ...
  public static CMakeListGenerator.Language AxlStrong(this CMakeListGenerator.Language l) {
    return CMakeListGenerator.Language.axlstrong;
  }
  
  public static CMakeListGenerator.Language AxlCaseAndStrong(this CMakeListGenerator.Language l) {
    return CMakeListGenerator.Language.axlcasestrong;
  }
  ...
  public static CMakeListGenerator.Language Law(this CMakeListGenerator.Language l) {
    return CMakeListGenerator.Language.law;
  }
  
  public static CMakeListGenerator.Language LawDebug(this CMakeListGenerator.Language l) {
  ...
  public static CMakeListGenerator.Language ServiceStrong(this CMakeListGenerator.Language l) {
    return CMakeListGenerator.Language.servicestrong;
  }

  public static CMakeListGenerator.Language ServiceCaseAndStrong(this CMakeListGenerator.Language l) {
    return CMakeListGenerator.Language.servicecasestrong;
  }
  ...
  public static bool isLaw(this CMakeListGenerator.Language l) {
    return l == CMakeListGenerator.Language.law;
  }
