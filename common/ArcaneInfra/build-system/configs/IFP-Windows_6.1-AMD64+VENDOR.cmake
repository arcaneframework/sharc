...
set(VS10_REDIST_PATH "C:/Program Files (x86)/Microsoft Visual Studio 10.0/VC/redist/x64/Microsoft.VC100.CRT")
set(VS12_REDIST_PATH "C:/Program Files (x86)/Microsoft Visual Studio 12.0/VC/redist/x64/Microsoft.VC120.CRT")
...
if(CMAKE_BUILD_TYPE STREQUAL "Release")
	...
	set(ALIEN_ROOT
		${RESOLVED_ALIEN_PATH}/Windows/Seven/x86-64/ref-arcane-2.2.1-wo-metis-vs12-IntelMpi4
...
if(CMAKE_BUILD_TYPE STREQUAL "Debug")
	...
	set(ALIEN_ROOT
		${RESOLVED_ALIEN_PATH}/Windows/Seven/x86-64/dbg-arcane-2.2.1-wo-metis-vs12-IntelMpi4
		CACHE INTERNAL "ALIEN root path")
endif()
...
set(EIGEN3_ROOT
    ${SOFTS_BASE_PATH}/eigen3/eigen-3.3.1
...
# problème d'installation, on doit recopier ces libs
set(EXTRA_DLLS_TO_COPY 
	...
	${VS10_REDIST_PATH}/msvcp100.dll
	${VS10_REDIST_PATH}/msvcr100.dll
	${VS12_REDIST_PATH}/msvcp120.dll
	${VS12_REDIST_PATH}/msvcr120.dll
