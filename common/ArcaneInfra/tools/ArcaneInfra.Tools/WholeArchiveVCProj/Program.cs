...
namespace ArcaneInfra.WholeArchiveVCProj
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else if (vstudio_name == "Visual Studio 12 Win64" || vstudio_name == "Visual Studio 12 2013 Win64")
            {
              vstudio = VisualStudioKind.VCXProj;
            }
            else if (vstudio_name == "Visual Studio 15 2017 Win64")
            {
                vstudio = VisualStudioKind.VCXProj;
            }
            else
            ...
            if (vstudio == VisualStudioKind.VCProj)
                filename = Path.ChangeExtension(filename, ".vcproj");
            else if (vstudio == VisualStudioKind.VCXProj) // && vstudio_name != "Visual Studio 15 2017 Win64")
            //    filename = Path.ChangeExtension(filename, ".vcxproj");
            //else if (vstudio == VisualStudioKind.VCXProj && vstudio_name == "Visual Studio 15 2017 Win64")
                filename = filename + ".vcxproj";
