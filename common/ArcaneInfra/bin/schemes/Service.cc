...
//#include "fullpath/I${name}.h" // Renseigner le nom et chemin de l'interface
class I${name} { }; // Interface temporaire pour compilation en l'etat 
                    // (doit etre remplacee par la ligne precedente a terme)
